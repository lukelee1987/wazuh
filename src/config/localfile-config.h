 ...
 */
typedef struct {
    int lines_count; ///< Number of lines read
    char * buffer;   ///< Log content currently
    long timeout;    ///< timestamp of last line read
...
typedef struct {
    ...
    w_multiline_timeout_ctxt_t * timeout_ctxt; ///< multiline context
